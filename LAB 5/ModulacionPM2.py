...
# Title: Modulacion PM 2
# Author: Mateo Natalia
...
class ModulacionPM2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulacion PM 2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion PM 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPM2")
...
def main(top_block_cls=ModulacionPM2, options=None):
