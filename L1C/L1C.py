...
class L1C(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "L1C")
        ...
        self._Ka_range = Range(0, 4, 0.000100, 1, 200)
        ...
        self._Ac_range = Range(0, 1, 0.000100, 0.100, 200)
        ...
        self._A_range = Range(0, 1, 0.000100, 0.100, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud del modulante", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=L1C, options=None):
