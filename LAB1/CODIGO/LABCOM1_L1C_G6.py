...
class LABCOM1_L1C_G6(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Práctica1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Práctica1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LABCOM1_L1C_G6")
        ...
        self.analog_sig_source_x_0.set_block_alias("freq")
...
def main(top_block_cls=LABCOM1_L1C_G6, options=None):
